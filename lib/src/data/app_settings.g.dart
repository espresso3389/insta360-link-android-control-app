...
AppSettings _appSettingsDeserialize(
  ...
  object.id = id;
  object.serverUrl = reader.readString(offsets[0]);
  return object;
}
...
extension AppSettingsQuerySortBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> sortByServerUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'serverUrl', Sort.asc);
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> sortByServerUrlDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingsQuerySortThenBy
  ...
  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> thenByServerUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'serverUrl', Sort.asc);
    });
  }

  QueryBuilder<AppSettings, AppSettings, QAfterSortBy> thenByServerUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'serverUrl', Sort.desc);
    });
  }
...
extension AppSettingsQueryWhereDistinct
  ...
  QueryBuilder<AppSettings, AppSettings, QDistinct> distinctByServerUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension AppSettingsQueryProperty
  ...
  QueryBuilder<AppSettings, String, QQueryOperations> serverUrlProperty() {
    return QueryBuilder.apply(this, (query) {
